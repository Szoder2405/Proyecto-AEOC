Ipopt 3.14.19 DLL build with
- linear solver Mumps 5.8.0 (default)
- linear solver Pardsio from Intel MKL
- Metis 5.2.1
- Ampl Solver Library (ASL) 2024-11-08
- Intel MKL 2024.1 parallel
